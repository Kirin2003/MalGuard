...
def main():
    ...
    mal_data_path = r'/Data2/hxq/MalGuard/fea_ex/malware_features.txt'
    ben_data_path = r'/Data2/hxq/MalGuard/fea_ex/benign_features.txt'
    ...
    train_with_progress_bar(sgd_model, X_train, y_train, X_test, y_test, "SGD Classifier", model_save_path,
                            sensitive_apis, n_iter=100)

    # XGB
    xgb_model = xgb.XGBClassifier(n_estimators=100, learning_rate=0.1, max_depth=6, random_state=42,
                                  use_label_encoder=False, eval_metric='logloss')
    train_with_progress_bar(xgb_model, X_train, y_train, X_test, y_test, "XGBoost", model_save_path, sensitive_apis, n_iter=100)
